...
1. The Intel manuals (Volume 1, Volume 2, Volume 3).
2. A brief guide on the 30386 architecture.
...
1. make sure your output is intuitive and clean---simplifying Grader's grading is always good.

2. go to the csc501-lab0/compile directory and do make clean.
3. create a subdirectory TMP under the directory csc501-lab0 and copy all the files you have modified/written, .S, .c, and .h files into the directory.
4. compress the csc501-lab0 directory into a tgz file and use Moodle's Submit Assignment facility. Please only upload one tgz file.
5. tar czf csc501-lab0.tgz csc501-lab0
